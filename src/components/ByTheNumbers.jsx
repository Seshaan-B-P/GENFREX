    ...
    <section id="numbers" className="relative py-24 sm:py-36 bg-[#050505] border-b border-white/[0.08] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start pb-16 sm:pb-24 border-b border-white/[0.08]">
          ...
          {/* Right Bento Grid */}
          <div data-cursor="view" className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              <SpotlightCard className="p-6 h-full space-y-3 flex flex-col justify-between">
            ...
            >
              <SpotlightCard className="p-6 h-full space-y-3 relative overflow-hidden flex flex-col justify-between">
                <span className="text-[11px] font-mono text-zinc-400 uppercase tracking-widest font-semibold">
        ...
        <div className="pt-16 sm:pt-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-12">
            ...
            <div data-cursor="view" className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                <SpotlightCard className="p-5 h-full space-y-2 cursor-default">
              ...
              >
                <SpotlightCard className="p-5 h-full space-y-2 cursor-default border-primary/40 shadow-glow-sm">
                  <span className="text-[10px] font-mono text-primary uppercase tracking-wider font-bold">
                    PHASE 03 · BY YOU
                  </span>
          ...
          {/* Stat Footer with Magnetic Action */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
